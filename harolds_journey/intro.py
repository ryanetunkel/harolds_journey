...
from menu_vars import window_width, window_height
...
wizard_intro_start_x_pos = window_height * -(1/4)
...
wizard_intro_height_by_scale = window_height * (1/8)
wizard_intro_width_by_scale = window_height * (1/8)
